...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-table'></i>Customer Section</h1>
        </div>
            ...
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-header transparent">
                        <h2><strong>Customer Details</strong>
...
function listApplications1()
{

    $contact  = DB::query("select * from new_application where user_id = '".$_SESSION['customer_id']."'");
    if(DB::count() > 0)
    {
        $id = 1;
        foreach($contact as $contacts)
        {
            ...
            $application = DB::queryFirstRow("select application_date,first_name,last_name from new_application_customer where application_id = '$application_id'");
            ...
            {
                echo "<td><a href='generate_html_pdf.php?application_id=".$application_id."'><button class='btn btn-secondary' type='button'>View Application (PDF)</button></a> </td>";
            }
            else{
                echo "<td><a href='application-$step'><button class='btn btn-secondary' type='button'>Go To Application</button></a> </td>";
            }
