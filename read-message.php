					...
					<div class="row">
						<div class="col-md-3">
							...
							<div class="list-group menu-message">
							  <a href="inbox.php" class="list-group-item"><i class="icon-inbox"></i> Inbox <span class="badge pull-right"></span></a>
							...
							<div class="widget">
								<div class="col-sm-12">
									<?php
                                             $lists = DB::queryFirstRow("select * from logs_email where id = '$id'");
									...
									<div class="row">
										<div class="col-sm-8">
											<h3 class="semibold"><?=$lists['subject']?></h3>
										</div>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="mail-sender-details">
												<img src="images/users/chat/19.jpg" class="img-circle sender-photo"> <small><b> <span class="text-muted"><?=$lists['email_to']?></span><br><span class="text-muted"><?=$lists['date']?></span></b></small>
											</div>
										</div>
