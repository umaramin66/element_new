...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Create Leads</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Create Leads Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-client"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label">Company Name(IfApplicable)</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <button id="b_n" type="submit" class="btn btn-foursquare" data-toggle="tooltip">Create Leads</button>
                        </div> 
                    </div>
