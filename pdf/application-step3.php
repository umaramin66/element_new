...
<!--            <h1><i class='fa fa-check'></i> Forms</h1>-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Employment Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-step3"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select onchange="open_panel()" class="form-control" id="type_of_employment_year" name="type_of_employment_year[]">
                                        ...
                                        <option value="2019"<?=$type_of_employment_year == '2019' ? ' selected="selected"' : '';?>>2019</option>
                    ...
                    <div id="previous-employment1">
                        ...
                        <div class="form-group">
                            <label for="input-text-help" class="col-sm-2 control-label">Company/Business Name</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="company_business_name1" name="company_business_name[]" value="<?=$company_business_name1?>"  placeholder="Business Name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input-text-help" class="col-sm-2 control-label">Company Address:</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select onchange="open_panel2()" class="form-control" id="type_of_employment_year1" name="type_of_employment_year[]">
                                    ...
                                    <option value="2019"<?=$type_of_employment_year1 == '2019' ? ' selected="selected"' : '';?>>2019</option>
                    ...
                    <div id="previous-employment2">
                        ...
                        <div class="form-group">
                            <label for="input-text-help" class="col-sm-2 control-label">Job Title </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="job_title1" name="job_title[]" value="<?=$job_title2?>"  placeholder="Job Title">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="input-text-help" class="col-sm-2 control-label">Company/Business Name</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="company_business_name1" name="company_business_name[]" value="<?=$company_business_name2?>"  placeholder="company Business Name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input-text-help" class="col-sm-2 control-label">Company Address:</label>
                        ...
                        <div class="form-group">
                            <label for="inputPassword" class="col-sm-2 control-label">Contact No</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="manager_hr_contact_no2" name="manager_hr_contact_no[]"  value="<?=$manager_hr_contact_no2?>" placeholder="Contact No">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Began Employment:</label>
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="type_of_employment_year2" name="type_of_employment_year[]">
                                    ...
                                    <option value="2012"<?=$type_of_employment_year2 == '2012' ? ' selected="selected"' : '';?>>2012</option>
