...
<!--                            <p>Copper / $250,000.00</p>-->
            ...
            <div class="three-box">
                <div class="box-frame">
                    ...
                    <button type="button" class="btn btn-outline-primary"><a href="" data-toggle="modal" data-target="#TaxInvoiceModal" class="Tax">Tax Invoice Request</a></button>
                    ...
                    <button type="button" class="btn btn-outline-primary"><a class="privacy">Privacy</a></button>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary">Download Application PDF</button>
                </div>
