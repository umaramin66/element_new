...
<div class='main'>
    <div class=\'header\'>
        ...
        <p style='margin: -80px 0px 0px 0px; text-align: center;'> <b>Delivered To:</b><br>
    ...
    <div>
        ...
        <div>";
            foreach ($one as $assets) {
                ...
                <tr style='border: none;text-align:left;'><td>One (1) only</td><td><a>" . $assets['one_only'] . "</a></td></tr>
                <tr style='border: none;text-align:left;'><td>Year:</td><td><a>" . $assets['year'] . "</a></td></tr>
                <tr style='border: none;text-align:left;'><td>Reg No:</td><td><a>" . $assets['reg_no'] . "</a></td></tr>
                <tr style='border: none;text-align:left;'><td>Engine No:</td><td><a>" . $assets['engine_no'] . "</a></td></tr>
                <tr style='border: none;text-align:left;'><td>Vin No:</td><td><a>" . $assets['vin_no'] . "</a></td></tr>
                <tr style='border: none;text-align:left;'><td>Odometer: </td><td><a>" . $assets['odometer'] . "</a></td></tr>
                </table>";
            }
        ...
        <div >
            ...
            foreach ($banks as $bank) {
                $html .= "<table>
                <tr style='text-align: left; border:none;' ><td><span style='color: red'>BANK:</span> &nbsp;&nbsp;".$bank['bank']."</td></tr>
                <tr style='text-align: left; border:none;' ><td><span style='color: red'>A/C NAME:</span> &nbsp;&nbsp;".$bank['ac_no']."</td></tr>
                <tr style='text-align: left; border:none;' ><td><span style='color: red'>BSB:</span>&nbsp;&nbsp;".$bank['bsb']."</td></tr>
                <tr style='text-align: left; border:none;' ><td><span style='color: red'>ACOUNT NUMBER:</span>&nbsp;&nbsp; ".$bank['amount']."</td></tr>
                <tr style='text-align: right; border:none;padding-bottom: 30px;' ><td>$".$data['total_amount_due']."</td></tr>
