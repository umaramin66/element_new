...
$request->setTitle('ESIGN Privacy');
$request->setSubject('ESIGN Privacy');
$request->setMessage('ESIGN Credit Privacy');
...
$request->addFile('../qs-php-master/pdf_design_ahmad/pdf_design/privacy.pdf');
