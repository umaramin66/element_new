...
$request->setTitle('ESIGN Credit Guide');
$request->setSubject('ESIGN Credit Guide');
$request->setMessage('ESIGN Credit Guide');
...
$request->addFile('../qs-php-master/pdf_design_ahmad/pdf_design/credit_guide.pdf');
