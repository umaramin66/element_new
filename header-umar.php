...
<head>
    ...
    <link href="assets/css/umar-style.css" rel="stylesheet" />
...
<!--                                        <div class="left-btn"><a class="btn btn-sm btn-default add-todo"><i class="fa fa-plus"></i></a></div>-->
                                        <h2>Todo List</h2>
                                        <?php
                                        $list = DB::query("select * from logs where lead_id = '".$_GET['lead_id']."' order by id DESC limit 5");
...
<!--                                                <span class="check-icon"></span>-->
                                                <span class="todo-item"><?=$lists['log_detail']?></span>
                                                <?php } ?>
