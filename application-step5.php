...
<!--            <h1><i class='fa fa-check'></i>Step 5</h1>-->
        </div>
        <div class="form-group">
            <h4><strong>EXPENSES</strong></h4>
        </div>
        <div class="form-group">
            <h5 style="font-weight: 500;">Please provide an <b>estimate house hold expenses</b> for the following as accurate as possible:</h5>
        </div>
        <!-- Page Heading End-->
               ...
               <!-- <div class="widget-header transparent">
                ...
                <div class="widget-content padding">
                    <div id="horizontal-form">
                        <form id="add-step5" class="form-horizontal"  method="post" enctype="multipart/form-data" role="form">
                            <div class="widget">

                                <div class="widget-content padding">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">*Groceries</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-2 control-label">Per</label>
                                        <div class="col-sm-10">
                            ...
                            <div class="widget">
                                <div class="widget-content padding">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">*Utility Bills</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="utility_bills" name="utility_bills" value="<?=$utility_bills?>"  placeholder="">
                                        <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="utility_bills_error"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">Per</label>
                            ...
                            <div class="widget">
                                <div class="widget-content padding">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">*Insurance Bills</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="widget">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="mobile_phone" name="mobile_phone" value="<?=$mobile_phone?>"  placeholder="">
                                        <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="mobile_phone_error"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">Per</label>
                            ...
                            <div class="widget">
                                <div class="widget-content padding">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">*Fuel/Car Expenses</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="widget">
                                <div class="widget-content padding">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">*Other Regular Expenses <br>  Other Regular Expenses<small>(Memberships, bills, entertainment Eating out ect)</small></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="other_regular_expenses" name="other_regular_expenses" value="<?=$other_regular_expenses?>"  placeholder="">
                                        <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="fuel_car_expenses_error"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="widget">
                                <div class="widget-content padding">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Description Of Other Expenses</label>
                                    <div class="col-sm-10">
                            ...
                            <!--          Please note if in the first page main application page they selected From
                                      “residence status” “renitng” then below questions should apear and ask,
                                      if “owned “mortgaged” then should ask for mortgage repayments as per below-->
                            ...
                            <!--
                                    Mortagege Repayment  Case 2 -->
                            <div class="widget">
                                <div class="widget-content padding">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Mortagege/Boarding Repayment</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="widget">
                                <div class="widget-content padding">
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-2 control-label">Any Foreseen Changes In Expenses:</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" id="forseen_changes_expenses_select" name="forseen_changes_expenses_select">
                                                <option value=""></option>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">If Yes Please Specify</label>
                                        <div class="col-sm-10">
