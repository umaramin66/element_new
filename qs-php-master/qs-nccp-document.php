...
function send_document_for_signing($email,$name){
    ...
    $fileNamePath = 'pdf_design_ahmad/pdf_design/nccp.pdf';
    ...
    $document = new DocuSign\eSign\Model\Document([
        ...
        'name' => 'NCCP document', # can be different from actual file name
    ...
    $envelopeDefinition = new DocuSign\eSign\Model\EnvelopeDefinition([
        'email_subject' => "Element - Please Sign this NCCP Document",
