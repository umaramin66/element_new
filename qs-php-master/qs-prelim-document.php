...
function send_document_for_signing($email,$name){
    ...
    $fileNamePath = 'pdf_design_ahmad/pdf_design/prelim.pdf';
    ...
    $document = new DocuSign\eSign\Model\Document([
        ...
        'name' => 'Prelim Assesment Document', # can be different from actual file name
    ...
    $envelopeDefinition = new DocuSign\eSign\Model\EnvelopeDefinition([
        'email_subject' => "(Element) Please Sign this Prelim Assesment Document",
