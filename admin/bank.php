...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-table'></i> Bank Section</h1>
            ...
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-header transparent">
                        <h2><strong>Bank Detail</strong>
                            <input style="margin-left:300px;"type="button" class="btn btn-foursquare" value="Add Bank" onclick=" relocate_home()">
                        </h2>
                    ...
                    <div class="widget-content">
                        ...
                        <div class="table-responsive">
                            <table id="bank_table"  data-sortable class="table table-hover table-striped">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
...
function listbank()
{
    ...
    $contact  = DB::query("select * from bank");
    if(DB::count() > 0)
    {
        foreach($contact as $contacts)
        {
            ...
            echo"<tr><th scope='row'>$id</th>
                ...
                <td>
                <a href='edit-bank.php?edit-bank=$id'><button class='btn btn-foursquare' type='button'>Edit Banks</button></a>
                <a href='list-bank.php?list-bank=$id'><button class='btn btn-github' type='button'>List Bank</button></a> </td>
