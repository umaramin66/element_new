...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-table'></i> Company Section</h1>
            ...
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-header transparent">
                        <h2><strong>Company Detail</strong>
                            <input style="margin-left:300px;"type="button" class="btn btn-foursquare" value="Add Company" onclick=" relocate_home()">
                        </h2>
                    ...
                    <div class="widget-content">
                        ...
                        <div class="table-responsive">
                            <table id="company_table"  data-sortable class="table table-hover table-striped">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Logo</th>
...
function listcompany()
{
    ...
    $contact  = DB::query("select * from company");
    if(DB::count() > 0)
    {
        foreach($contact as $contacts)
        {
            ...
            $abn = $contacts['abn'];
            $officeAddress = $contacts['office_address'];
            $aclNo = $contacts['acl_no'];
            ...
            echo"<tr><th scope='row'>$id</th>
                ...
                <td><a href='view-broker.php?view-broker=$id'><button class='btn btn-foursquare' type='button'>View Brokers</button></a> </td>
                <td><a href='edit-company.php?edit-company=$id'><button class='btn btn-github' type='button'>Edit</button></a> </td>
