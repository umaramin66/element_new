...
//                 foreach($contact as $edit_contact)
//                 {

//                     $name= $edit_contact["name"];
//                     $company = $edit_contact['company_name'];
//                     $contact = $edit_contact['contact_no'];
//                     $association = $edit_contact['association'];
//                     $notes = $edit_contact['notes'];
//                 }
    ...
    <div class="content">
        ...
        <div class="widget">
            ...
            <div class="widget-content padding">
                <form id="edit_contact"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="input-text" class="col-sm-2 control-label"> Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="client_name" name="client_name" value="<?php echo $getData['name']?>"  placeholder="Input text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="company_name" name="company_name" value="<?php echo $getData['company']?>" placeholder="Company Name">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="contact_no" name="contact_no" value="<?php echo $getData['contact_no']?>" placeholder="Contact No">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1" class="col-sm-2 control-label">Association</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="association" name="association" value="<?php echo $getData['association']?>" placeholder="Enter association">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlSelect1" class="col-sm-2 control-label">Notes</label>
                        <div class="col-sm-10"> 
                            <textarea class="form-control" id="notes" name="notes" rows="4" cols="50">
                            <?php echo $notes?>
                        </textarea>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <button type="submit" class="btn btn-primary" title="btn btn-primary" data-toggle="tooltip">Edit contact</button>
                        </div>
...
<script src="assets/js/edit_contact.js"></script>
<?php
include 'footer.php';
?>
