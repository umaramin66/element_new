...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Contacts</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Contacts Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-contact"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="association" name="association"  placeholder="Enter association">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <button type="submit" class="btn btn-primary" title="btn btn-primary" data-toggle="tooltip">Create contact</button>
                        </div>
