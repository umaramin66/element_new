            ...
            <div class="widget-content padding">
                <form id="add-client"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            <input type="radio" class="form-control" id="asset_finance" name="loan_type"  <?php if($loan_type=="asset_finance") { echo "checked";  }?>  value="asset_finance"  placeholder="">
                        </div>
                        <label for="input-text-help" class="col-sm-2 control-label" for="asset_finance">ASSET FIANANCE</label>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            <input type="radio" class="form-control" id="personal_loan" name="loan_type"  <?php if($loan_type=="personal_loan") { echo "checked";  }?>  value="personal_loan"  placeholder="">
                        </div>
                        <label for="input-text-help" class="col-sm-2 control-label" for="personal_loan">PERSONAL LOAN</label>
                    </div>
                    <?php } ?> 
                    <br><br>
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            <input type="radio" class="form-control" id="business_loan" name="loan_type"  <?php if($loan_type=="business_loan") { echo "checked";  }?>  value="business_loan"  placeholder="">
                        </div>
                        <label for="input-text-help" class="col-sm-2 control-label" for="business_loan">BUSINESS LOAN</label>
                    </div>
                    <br><br>


                    <div id="asset_finance_div">

                        <div class="form-group">
                           <label for="input-text-help" class="col-sm-2 control-label">Loan Amount</label>
                            <div class="col-sm-10">
                               <input type="text" id="loan_amount_asset_finance" class="form-control" name="loan_amount_asset_finance" value="<?=$ap['loan_amount_asset_finance+
                               ']?>"  placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                           <label for="input-text-help" class="col-sm-2 control-label">Deposit (If Any)</label>
                            <div class="col-sm-10">
                               <input type="text" class="form-control" id="deposit_asset_finance" name="deposit_asset_finance" value="<?=$ap['deposit_asset_finance']?>"  placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                           <label for="input-text-help" class="col-sm-2 control-label">Residual Balloon</label>
                            <div class="col-sm-10">
                               <input type="text" class="form-control" id="residual_balloon_asset_finance" name="residual_balloon_asset_finance" value="<?=$ap['residual_balloon_asset_finance']?>"  placeholder="">
                            </div>
                        ...
                        <div class="form-group">
                           <label for="input-text-help" class="col-sm-2 control-label">Or Amount $</label>
                            <div class="col-sm-10">
                               <input type="text" class="form-control" id="amount_asset_finance" name="amount_asset_finance" value="<?=$ap['amount_asset_finance']?>"  placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="radio" class="form-control" id="asset_detail1" name="asset_detail_radio"  <?php if($asset_detail_radio=="new") { echo "checked";  }?>  value="new"  placeholder="">
                            </div>
                            <label for="input-text-help" class="col-sm-2 control-label" for="asset_detail1">New</label>
                        </div>

                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="radio" class="form-control" id="asset_detail2" name="asset_detail_radio"  <?php if($asset_detail_radio=="used") { echo "checked";  }?>  value="used"  placeholder="">
                            </div>
                            <label for="input-text-help" class="col-sm-2 control-label" for="asset_detai2">Used</label>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="radio" class="form-control" id="asset_detail3" name="asset_detail_radio"  <?php if($asset_detail_radio=="demo") { echo "checked";  }?>  value="demo"  placeholder="">
                            </div>
                            <label for="input-text-help" class="col-sm-2 control-label" for="asset_detai3">Used</label>
                        </div>
                        <div class="form-group">
                           <label for="input-text-help" class="col-sm-2 control-label">Build Year </label>
                            <div class="col-sm-10">
                         ...
                         <div class="form-group">
                            <div class="col-sm-10">
                                <input type="radio" class="form-control" id="asset_detail_build_year_id" name="asset_detail_radio"  <?php if($asset_detail_build_year_radio=="unsure") { echo "checked";  }?>  value="unsure"  placeholder="">
                            </div>
                            <label for="input-text-help" class="col-sm-2 control-label" for="asset_detail_build_year_id">Unsure</label>
                        </div>
                        <div class="form-group">
                           <label for="input-text-help" class="col-sm-2 control-label">Make </label>
                            <div class="col-sm-10">
                         ...
                         <div class="form-group">
                            <div class="col-sm-10">
                                <input type="radio" class="form-control" id="asset_detail_make_id" name="asset_detail_make_radio"  <?php if($asset_detail_make_radio=="unsure") { echo "checked";  }?>  value="make"  placeholder="">
                            </div>
                            <label for="input-text-help" class="col-sm-2 control-label" for="asset_detail_make_id">Unsure</label>
                        </div>


                        <div class="form-group">
                           <label for="input-text-help" class="col-sm-2 control-label">Buying From : </label>
                        </div>
                         <div class="form-group">
                            <div class="col-sm-10">
                                <input type="radio" class="form-control" id="asset_detail_buying_from_id" value="dealer" <?php if($asset_detail_buying_from_radio=="dealer") { echo "checked";  }?>  name="asset_detail_buying_from_radio"     placeholder="">
                            </div>
                            <label for="input-text-help" class="col-sm-2 control-label" for="asset_detail_buying_from">Dealer</label>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="radio" class="form-control" id="asset_detail_buying_from1"  value="private"  <?php if($asset_detail_buying_from_radio=="private") { echo "checked";  }?>  name="asset_detail_buying_from_radio"   placeholder="">
                            </div>
                            <label for="input-text-help" class="col-sm-2 control-label" for="asset_detail_buying_from1">Private</label>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-10">
                                <input type="radio" class="form-control" id="asset_detail_buying_from2"  value="unsure"  <?php if($asset_detail_buying_from_radio=="unsure") { echo "checked";  }?>  name="asset_detail_buying_from_radio"   placeholder="">
                            </div>
                            <label for="input-text-help" class="col-sm-2 control-label" for="asset_detail_buying_from2">Unsure</label>
                        </div>
                    ...
                    <div id="personal_loan_box">
                        ...
                        <div class="form-group">
                           <label for="input-text-help" class="col-sm-2 control-label">Loan Amount</label>
                            <div class="col-sm-10">
                               <input type="text" id="loan_amount_asset_personal" class="form-control" name="loan_amount_asset_personal" value="<?=$ap['loan_amount_asset_finance
                               ']?>"  placeholder="">
                            </div>
                        </div>
                    ...
                    <div id="business_loan_box">
                        ...
                        <div class="form-group">
                           <label for="input-text-help" class="col-sm-2 control-label">Loan Amount</label>
                            <div class="col-sm-10">
                               <input type="text" id="loan_amount_business" class="form-control" name="loan_amount_business" value="<?=$ap['loan_amount_asset_finance
                               ']?>"  placeholder="">
                            </div>
                        </div>
