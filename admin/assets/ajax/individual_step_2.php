...
DB::insert('new_application_customer', array(
    ...
    "time_at_the_address"                =>  $_POST['time_at_the_address'],
...
$s .= "<p><a href='https://hotfixtech.com/element/redirect_from_email.php'> Go To Application</a> and enter the above credentials to continue</p>
