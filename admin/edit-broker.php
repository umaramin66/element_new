...
if(isset($_GET['edit-broker'])) {

    $id = $_GET['edit-broker'];
    $getData = DB::queryFirstRow("select * from brokers where id = '$id'");
}
...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Update Broker</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Update Broker Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="edit-broker"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <input type="hidden" id="broker_id" name="broker_id" value="<?php echo $id?>" >
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" title="Update Broker" data-toggle="tooltip">Update Broker</button>
                    </div>
                </form>
            </div>
...
<script src="assets/js/edit-broker.js"></script>
<?php
include 'footer.php';
?>
