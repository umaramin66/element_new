...
if(isset($_GET['edit-bank'])) {

    $id = $_GET['edit-bank'];
    $getData = DB::queryFirstRow("select * from bank");
}
...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Update Bank</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Update Bank Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="edit-broker"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" name="name" value="<?php echo $getData['name'] ?>"   placeholder="Enter Name">
                            <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="name_error"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label"> Address</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="address" name="address" value="<?php echo $getData['address']?>"  placeholder=" Address">
                            <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="address_error"></span>
                        </div>
                    </div>
                    ...
                    <input type="hidden" id="bank_id" name="bank_id" value="<?php echo $id?>" >
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" title="Update Bank" data-toggle="tooltip">Update Bank</button>
                    </div>
                </form>
            </div>
...
<script src="assets/js/edit-bank.js"></script>
<?php
include 'footer.php';
?>
