...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Bank</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Create Bank</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-bank"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-foursquare" title="Add Bank" data-toggle="tooltip">Add Bank</button>
                    </div>
                </form>
            </div>
