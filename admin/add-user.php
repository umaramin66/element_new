...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Add User </h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Users Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-user"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label">Admin</label>
                        <div class="col-sm-10">
                            <input class="iradio_square-aero icheckbox_square-aero" type="radio"  id="admin" value="admin"  name="user_type" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label">Company</label>
                        <div class="col-sm-10">
                            <input class="iradio_square-aero icheckbox_square-aero" type="radio"  id="company" value="company"  name="user_type" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label"> Settlement Officer</label>
                        <div class="col-sm-10">
                            <input class="iradio_square-aero icheckbox_square-aero" type="radio"  id="settlement_officer" value="settlement_officer"  name="user_type" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label">Broker</label>
                        <div class="col-sm-10">
                            <input class="iradio_square-aero icheckbox_square-aero" type="radio"  id="borker" value="broker"  name="user_type" class="form-control">
                        </div>
                    </div>
                   <div id="whole-div">
                       <div id="company-id" class="form-group">
                           <label class="col-sm-2 control-label">Company</label>
                           <div class="col-sm-10">
                               <select id="company_id" name="company_id" class="form-control">
                                   <?php $city = DB::query("select * from company");
                               ...
                               <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="comapany_id_error"></span>
                           </div>
                       </div>
                       <div class="form-group">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-foursquare" data-toggle="tooltip">Add Broker</button>
                    </div>
