...
<?php
error_reporting(0);
require_once __DIR__ . '/assets/inc/initDb.php';
...
if(isset($_GET['edit-company'])) {
    ...
    $getData = DB::queryFirstRow("select * from company where id = '$id'");
}
...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Update Company</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Update Company Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="edit-company"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    <div class="form-group">
                        <img id="new_image"  src="<?php echo $getData['logo'] ?>" width="130" height="130" class="img-radius" alt="User-Profile-Image">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="logo"></span>
                        </div>
                        <input class="form-control" type="hidden" name="hidden_image" id="hidden_image" value="0">
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"> Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" name="name"  value="<?php echo $getData['username']?>"  placeholder="User Name">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="username" name="username"  value="<?php echo $getData['username']?>"   placeholder="User Name">
                            <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="username_error"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="trading_name" name="trading_name" value="<?php echo $getData['trading_name'] ?>"   placeholder="Trading Name">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="abn" name="abn" value="<?php echo $getData['abn'] ?>"  placeholder="Abn">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="office_address" name="office_address" value="<?php echo $getData['office_address']?>"  placeholder="Office Address">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="acl_no" name="acl_no" value="<?php echo $getData['acl_no']?>"  placeholder="Acl No">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="credit_rep_no" name="credit_rep_no" value="<?php echo $getData['credit_rep_no']?>"  placeholder="Credit Rep No">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="contact_name" name="contact_name"value="<?php echo $getData['contact_number']?>"  placeholder="Contact Name">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="contact_number" name="contact_number" value="<?php echo $getData['contact_number']?>"  placeholder="Contact Number">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="Number_of_directors" name="number_f_directors" value="<?php echo $getData['number_of_directors']?>"   placeholder="Number Of Directors">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="contact_Email" name="contact_Email" value="<?php echo $getData['contact_email']?>"  placeholder="Contact Number">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="password" name="password"  value="<?php echo $getData['password']?>"  placeholder="Enter Password">
                            <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="passsword_error"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label">Logo</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="logo" name="logo"  value="<?php echo $getData['logo']?>">
                            <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="passsword_error"></span>
                        </div>
                    </div>
                    <input type="hidden" id="company_id" name="company_id" value="<?php echo $id?>" >
                    <div class="form-group">
                        <button type="submit" class="btn btn-github" title="Update Broker" data-toggle="tooltip">Update Company</button>
                    </div>
                </form>
            </div>
...
<script src="assets/js/edit-company.js"></script>
<script>
