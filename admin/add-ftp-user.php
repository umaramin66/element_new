...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>FTP User</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Create FTP User</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-ftp-user"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">

                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-foursquare" title="Add Broker" data-toggle="tooltip">Add FTP User</button>
                    </div>
                </form>
            </div>
...
<script src="assets/js/add-ftp-user.js"></script>
<?php
function listFtp()
{

    $contact  = DB::query("select * from ftp_login");
    if(DB::count() > 0)
    {
