        ...
        <div class="widget">
            ...
            <div class="widget-content padding">
                <form id="add-client"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <br><br>
                    <button type="submit" id="investment-button" class="btn btn-primary">Add</button>
                                ...
                                { ?>
                                    ...
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Estimated Value:</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="investment_properties_estimated_value[]" value="<?=$ap['investment_properties_estimated_value']?>"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <br><br>
                                 ...
                                 <button type="submit" id="motor-button" class="btn btn-primary">Add</button>
                    ...
                    <br><br>
                                <button type="submit" id="recreational-button" class="btn btn-primary">Add</button>
                            ...
                            if(DB::count() != 0)
                            {
                                ...
                                { ?>
                                    ...
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Estimated Value:</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="motor_vehicles_estimated_value[]" value="<?=$ap3['recreational_assets_estimated_value']?>"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Loan Balance (IF ANY):</label>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <label for="input-text-help" class="col-sm-2 control-label">Repayments(IF ANY)</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" id="recreational_assets_repayments" name="motor_vehicles_repayments[]" value="<?=$ap3['recreational_assets_repayments']?>"  placeholder="">
                                        </div>
                                    </div>
                    ...
                    <br><br>
                            ...
                            <button type="submit" id="other_assets-button" class="btn btn-primary">Add</button>
                            ...
                            if(DB::count() != 0)
                            {
                                ...
                                { ?>
                                    ...
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Loan Balance (IF ANY):</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="recreational_assets_loan_balance[]" value="<?=$ap4['recreational_assets_loan_balance']?>"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Lender/Bank</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="recreational_assets_lender_bank[]" value="<?=$ap4['recreational_assets_lender_bank']?>"  placeholder="">
                                        </div>
                                    </div>
                                    </div><div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Repayments(IF ANY)</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" id="recreational_assets_repayments" name="recreational_assets_repayments[]" value="<?=$ap4['recreational_assets_repayments']?>"  placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-10">
                                            <select class="form-control" name="recreational_assets_repayments_select[]">
                                               ...
                                               <option value="week"<?=$ap4['recreational_assets_repayments_select'] == 'week' ? ' selected="selected"' : '';?>>Week</option>

                                               <option value="fortnight"<?=$ap4['recreational_assets_repayments_select'] == 'fortnight' ? ' selected="selected"' : '';?>>Fortnight</option>

                                               <option value="month"<?=$ap4['recreational_assets_select'] == 'month' ? ' selected="selected"' : '';?>>Month</option>

                                               <option value="year"<?=$ap4['recreational_assets_repayments_select'] == 'year' ? ' selected="selected"' : '';?>>Year</option>
