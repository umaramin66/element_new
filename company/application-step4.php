        ...
        <div class="widget">
            ...
            <div class="widget-content padding">
                <form id="add-client"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label">Spouse Income<small>(If Applicable)</small></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label">Other Income (Net) After tax:<small>Rental Income, Centerlink other income</small></label>
                        <div class="col-sm-10">
