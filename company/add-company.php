...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Company</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Company Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-company"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" title="Add Broker" data-toggle="tooltip">Add Broker</button>
                    </div>
                </form>
            </div>
