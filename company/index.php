...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-table'></i> Broker Section</h1>
            ...
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-header transparent">
                        <h2><strong>Broker Detail</strong>
                            <input style="margin-left:300px;"type="button" class="btn btn-foursquare" value="Create Broker" onclick=" relocate_home()">
                        </h2>
                    ...
                    <div class="widget-content">
                        ...
                        <div class="table-responsive">
                            <table id="broker_table"  data-sortable class="table table-hover table-striped">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Logo</th>
...
function listbroker()
{
    ...
    $contact  = DB::query("select * from brokers where company_id = '".$_SESSION['company_id']."'");
    if(DB::count() > 0)
    {
        foreach($contact as $contacts)
        {
            $id = $contacts['id'];
            $logo = $contacts['logo'];
            $tradingName = $contacts['trading_name'];
            $office_address = $contacts['office_address'];
            $contactName = $contacts['contact_name'];
            $contactNumber = $contacts['contact_number'];
            $contactEmail = $contacts['contact_email'];



            echo"<tr><th scope='row'>$id</th>
                <td><img style='width:150px' src='$logo'></td>
                <td>$tradingName</td>
                <td>$office_address</td>
                <td>$contactName </td>
                <td> $contactNumber</td>
                <td> $contactEmail</td>
                     <td><a href='view-leads.php?view-lead=$id'><button class='btn btn-foursquare' type='button'>View Leads</button></a> </td>
                <td><a href='edit-broker.php?edit-broker=$id'><button class='btn btn-github' type='button'>Edit</button></a> </td>
