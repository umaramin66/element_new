    ...
    if(DB::count() > 0)
    {
        foreach($contact as $contacts)
        {
            ...
            echo"<tr><th scope='row'>$id</th>
                ...
                <td><a href='view-broker.php?view-broker=$id'><button class='btn btn-secondary' type='button'>View Brokers</button></a> </td>
                <td><a href='edit-company.php?edit-company=$id'><button class='btn btn-secondary' type='button'>Edit</button></a> </td>
