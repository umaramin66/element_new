...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Broker</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Broker Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-broker"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">

                    <div class="form-group">
                        <label class="col-sm-2 control-label">Company</label>
                        <div class="col-sm-10">
                            <select id="company_id" name="company_id" class="form-control">
                                <?php $cities = DB::queryFirstRow("select * from company where id = '".$_SESSION['company_id']."'");
                                ?>
                            ...
                            <span style="font-size: 12px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="broker_id_error"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-foursquare" title="Add Broker" data-toggle="tooltip">Add Broker</button>
                    </div>
                </form>
            </div>
