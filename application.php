...
if (!empty($_SESSION['application_id'])) {
    $ses = $_SESSION['application_id'];
}
if ($_SERVER['HTTP_REFERER'] == 'http://auzzietech.com/element/application-step8.php') {
    $s = DB::queryFirstRow("select * from new_application where id = '$ses'");
}
else
    {
    $s['customer_type'] = "";
    ...
    <div class="content">
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Application Step 1</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-step1"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
...
<!--                                    <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked>-->
                                    <input class="iradio_square-aero icheckbox_square-aero" type="radio"  id="individual" value="individual" <?php if($s['customer_type']=="individual") { echo "checked";  }?> name="customRadio" class="form-control"   >

                                    Individual(Consumer & PAYG Chattel )
                                </label>
                            </div>
                            <div class="radio iradio">
                                <label>
<!--                                    <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">-->
                                    <input class="iradio_square-aero icheckbox_square-aero" type="radio"  id="sole_trader" value="sole_trader" <?php if($s['customer_type']=="sole_trader") { echo "checked";  }?> name="customRadio" class="form-control"   >
                            ...
                            <div class="radio iradio">
                                <label>
                                    <!--                                    <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">-->
                                    <input class="iradio_square-aero icheckbox_square-aero" type="radio"  value="company" id="company" name="customRadio"  <?php if($s['customer_type']=="company") { echo "checked";  }?>  class="form-control"   >
                        ...
                        <div class="col-sm-10"><div class="radio iradio">
...
<!--                            <div class="radio iradio">-->
<!---->
<!--                                 <label for="input-text-help" class="col-sm-2 control-label" for="individual"">Individual(Consumer & PAYG Chattel )</label>-->
<!--                                <input type="radio"  id="individual" value="individual" --><?php //if($s['customer_type']=="individual") { echo "checked";  }?><!-- name="customRadio" class="form-control"   >-->
<!---->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                    <div class="form-group">-->
<!--                        <div class="col-sm-10">-->
<!--                            <input type="radio"  id="sole_trader" value="sole_trader" --><?php //if($s['customer_type']=="sole_trader") { echo "checked";  }?><!-- name="customRadio" class="form-control"   >-->
<!--                        </div>-->
<!--                        <label for="input-text-help" class="col-sm-2 control-label" for="sole_trader">Sole Trader</label>-->
<!--                    </div>-->
<!---->
<!--                    <br><br>-->
<!---->
<!--                    <div class="form-group">-->
<!--                        <div class="col-sm-10">-->
<!--                            <input type="radio"  value="company" id="company" name="customRadio"  --><?php //if($s['customer_type']=="company") { echo "checked";  }?><!--  class="form-control"   >-->
<!--                        </div>-->
<!--                        <label for="input-text-help" class="col-sm-2 control-label" for="company">Company</label>-->
<!--                    </div>-->
<!---->
<!--                    <br><br>-->
                </form>
