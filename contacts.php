...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <!--<h1><i class='fa fa-table'></i> Contacts Section</h1>-->
            
            <a style="margin-left:600px;" class="btn btn-primary text-right"value="Add Contact"  onclick=" relocate_home()"><i class="fa fa-plus-circle"></i>Add New</a>
        </div>
            ...
            <div class="col-md-12">
                <div class="widget pb-4">
                    <div class="widget-header transparent">
                      <!--  <h2><strong>Contact Detail</strong>
                            <input style="margin-left:300px;"type="button" class="btn btn-info" >
                        </h2>-->
...
<script>
    ...
    {
        location.href = "create_contacts.php";
    }
</script>
    ...
    if(DB::count() > 0)
    {
        foreach($contact as $contacts)
        {
            ...
            echo"<tr><th scope='row'>$id</th>
                <td>$name</td><td>$companyName</td><td>$contactNo</td><td>$association </td><td>$notes</td>
                <td><a href='edit_contact.php?edit_contact=$id'><button class='btn btn-success' type='button'>Edit</button></a> </td>
                </tr>";
        }
