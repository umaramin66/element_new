...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Create Referrer</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Create Referrer Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-referrer"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="input-text" class="col-sm-2 control-label"> Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" name="name"  placeholder="Input text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">Set_fee</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="set_fee" name="set_fee" placeholder="Input Text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">Ref_agreement</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="ref_agreement" name="ref_agreement" placeholder="Input Text">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2"></div>
                        <div class="col-sm-2">
                            <button type="submit" class="btn btn-foursquare" data-toggle="tooltip">Create Referrer</button>
                        </div>
                    </div>
...
<script src="assets/js/referrer.js"></script>
<?php
include 'footer.php';
?>
