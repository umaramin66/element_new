...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Create Contacts</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Create  Contacts Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-contact"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <button type="submit" class="btn btn-foursquare" data-toggle="tooltip">Create contact</button>
                        </div>
