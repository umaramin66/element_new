...
<!--            <h1><i class='fa fa-check'></i>Application (Step7)</h1>-->
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>LIABILITIES Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-client7"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <br><br>
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label"><b>Personal Loans</b></label>
                        <div class="col-sm-10">
                            <button type="button" id="personal-button" class="btn btn-primary">Add</button>
                            <small>*You can add multiple personal loans options by adding ADD button</small>
                        </div>
                    </div>
                                ...
                                { ?>
                                    ...
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Outstanding Balance:</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="personal_loans_outstanding_balance[]" value="<?=$ap['investment_properties_estimated_value']?>"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="col-md-1">
                                        <button style="overflow: hidden" class="btn btn-primary">Remove</button><br><br>
                                    </div>
                    ...
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label"><b>secured Loans</b></label>
                        <div class="col-sm-10">
                            <button type="button" id="secured-button" class="btn btn-primary">Add</button>
                            <small>*You can add multiple secured loans options by adding ADD button</small>
                        </div>
                    </div>
                            ...
                            if(DB::count() != 0)
                            {
                                ...
                                { ?>
                                    ...
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Outstanding Balance:</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="secured_loans_outstanding_balance[]" value="<?=$ap['secured_loans_outstanding_balance']?>"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Repayments</label>
                    ...
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label"><b>Other Liabilities</b></label>
                        <div class="col-sm-10">
                            <button type="button" id="others-button" class="btn btn-primary">Add</button>
                            <small>*You can add other liabilities Loans options by adding ADD button</small>
                        </div>
                    </div>
                    <div id="other_liabilities_div">
                         <?php
                            $app1 = DB::query("select * from new_application_liabilities_other_liabilities where application_id = '".$_SESSION['application_id']."'");
                            if(DB::count() != 0)
                            {
                                foreach($app1 as $ap)
                                { ?>
                                    ...
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Outstanding Balance:</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="other_liabilities_outstanding_balance[]" value="<?=$ap['other_liabilities_outstanding_balance']?>"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <label for="input-text-help" class="col-sm-2 control-label">Repayments</label>
                                        <div class="col-sm-10">
                                           <input type="text" class="form-control" name="other_liabilities_repayments[]" value="<?=$ap['other_liabilities_repayments']?>"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Per</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" name="other_liabilities_repayments_select[]">
                                                ...
                                                <option value="week"<?=$ap['other_liabilities_repayments_select'] == 'week' ? ' selected="selected"' : '';?>>Week</option>

                                                <option value="fortnight"<?=$ap['other_liabilities_repayments_select'] == 'fortnight' ? ' selected="selected"' : '';?>>Fortnight</option>

                                                <option value="month"<?=$ap['other_liabilities_repayments_select'] == 'month' ? ' selected="selected"' : '';?>>Month</option>

                                                <option value="year"<?=$ap['other_liabilities_repayments_select'] == 'year' ? ' selected="selected"' : '';?>>Year</option>
                                    ...
                                    <div class="form-group">
                                        <label for="input-text-help" class="col-sm-2 control-label">Lender/Bank</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="other_liabilities_lender_bank[]" value="<?=$ap['other_liabilities_lender_bank']?>"  placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input-text-help" class="col-sm-2 control-label">Description</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="other_liabilities_description[]" value="<?=$ap['other_liabilities_description']?>"  placeholder="">
                                        </div>
                                    </div>
                                    <?php
                                }
                    ...
                    <br><br>
                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label"><b>Number OF CREDIT CARDS:</b></label>
                        <div class="col-sm-10">
                            <input type="text" id="no_of_credit_cards" value="<?=$no_of_credit_cards['no_of_credit_cards']?>"  pattern="\d*" maxlength="1"  name="no_of_credit_cards" class="form-control" onchange="show_credit_card_div()" placeholder="">
                        </div>
                    </div>
                    ...
                    <br><br>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary"  data-toggle="tooltip">Next</button>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var inputFieldOthers = '   <div class="ahmad-others">' +
            ...
            '                                            </div>' +
            '                                            <div class="col-md-2">' +
            '                                              <button  class="btn remove_other_loan_button1 btn-primary mb-2" type="button">Remove</button>' +
            '                                            </div>' +
            '                                        </div></div>';
        ...
        $("#other_liabilities_div").on('click', '.remove_other_loan_button1', function(e){
            e.preventDefault();
