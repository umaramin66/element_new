...
$i=0;
    ...
    $err="";
                ...
                if(isset($_GET['edit_contact'])){
                    ...
                    $edit_contact = "select * from contacts where id='$id'";

                    $run_edit = mysqli_query($conn, $edit_contact);
                    ...
                    $company = $row_edit['company_name'];

                    $contact = $row_edit['contact_no'];

                    $association = $row_edit['association'];
                ...
                if(isset($_POST['edit_contact']))
                {
                    ...
                    $name = $_POST['Name'];
                    $name = validation($name);//function in function.php

                    $company_name = $_POST['Company'];
                    $company_name = validation($company_name);

                    $contactno = $_POST['Contact'];
                    $contactno = validation($contactno);
                    ...
                    $required_fields = array('Name', 'Company', 'Contact', 'Association',);
                    $error_msg=[];
                    $i=0;
                    $err="";
                    ...
                    foreach ($required_fields as $field)
                    {
                        ...
                        {
                            $found_error = true;
                            $error_msg[$i] = " <br />-Please enter " . $field;
                            $err ="error occured";
                            $i++;
                        }
                    }

                    if ($err=="") //means that no field was empty
                    {


                        $sql = "update products set name='$name', company_name='$company_name', contact_no='$contactno', association='$association', notes='$product_img2' where id='$id'";


                        $edit_contact = mysqli_query($conn, $sql);
                        ...
                        if ($edit_contact)
                        {
                            header("Location: contacts.php?data=edited successfully!");
                        }
                    }
...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-check'></i>Edit Contact</h1>
        </div>
        <!-- Page Heading End-->
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>Edit Contact Section</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-client"  method="post" action="edit_contact.php"  enctype="multipart/form-data" class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="input-text" class="col-sm-2 control-label"> Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="client_name" name="Name" value="<?php echo $name; ?>" placeholder="Input text">
                            <div style="color:red"> <?php echo $error_msg[0]; ?></div>
                        </div>
                    </div>


                    <div class="form-group">
                        <label for="input-text-help" class="col-sm-2 control-label">Company Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="company_name" name="Company" value="<?php echo $company_name; ?>" placeholder="Company Name">
                            <!--<p class="help-block">Example block-level help text here.</p>-->
                            <div style="color:red"> <?php echo $error_msg[1]; ?></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">Contact No</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="contact_no" name="Contact" value="<?php echo $contactno; ?>" placeholder="Contact No">
                            <div style="color:red"> <?php echo $error_msg[2]; ?></div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">Association</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="association" id="contact_no" value="<?php echo $association; ?>" placeholder="Enter Text">
                            <div style="color:red"> <?php echo $error_msg[3]; ?></div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1" class="col-sm-2 control-label">Notes</label>
                        <div class="col-sm-10">
                             <textarea class="form-control" id="notes" name="notes" value="<?php echo $notes; ?>" rows="4" cols="50">

                             </textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="Submit" class="btn btn-github" name="edit_contact" value="edit Contact">
                    </div>
<!--                    <div class="form-group">-->
<!--                        <div class="col-sm-2"></div>-->
<!--                        <div class="col-sm-2">-->
<!--                            <button type="submit" class="btn btn-foursquare" value="edit Contact" data-toggle="tooltip">Edit Contact</button>-->
<!--                        </div>-->
<!--                    </div>-->
