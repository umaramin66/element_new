...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="page-heading">
            <h1><i class='fa fa-table'></i>Referrer Section</h1>
        </div>
            ...
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-header transparent">
                        <h2><strong>Referrer Details</strong>
                            <input style="margin-left:300px;"type="button" class="btn btn-foursquare" value="Add referrer" onclick=" relocate_home()">
                        </h2>
...
<script>
    ...
    {
        location.href = "referrer_add.php";
    }
</script>
    ...
    if(DB::count() > 0)
    {
        foreach($referrer as $contacts)
        {
            ...
            echo"<tr><th scope='row'>$id</th>
                ...
                <td><a href='referrer_edit.php?referrer_edit=$id'><button class='btn btn-github' type='button'>Edit</button></a></td>
