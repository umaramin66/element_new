    ...
    <div class="content">
        ...
        <div class="widget">
            <div class="widget-header transparent">
                <h2><strong>New Application</strong></h2>
            ...
            <div class="widget-content padding">
                <form id="add-step1"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <!--                                                        <input type="radio" id="send_app" value="send_app_link" name="app_type" class="custom-control-input">-->
                    <!--                                                        <label class="custom-control-label" for="send_app">Send App Link</label>-->
                    <!--                                                    </div>-->
...
<!--                                    <input class="iradio_square-aero icheckbox_square-aero" type="radio"  id="send_app" value="send_app_link"  name="app_type" class="form-control">-->
<!--                                    Send App Link-->
<!--                                </label>-->
<!--                            </div>-->
<!---->
...
<!--                    </div>-->
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="radio iradio">
                                <label>
                                    <!--                                    <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked>-->
                                    <input class="iradio_square-aero icheckbox_square-aero" type="radio"  id="own" value="fill_own"  name="app_type" class="form-control"   >

                                    You fill Own (Client over the phone)
                                </label>
                            </div>
                ...
                <div id="email_box">
                    <form id="new-app"  method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            <div class="col-md-2">
                                <label>Enter Email </label>
                            </div>
                            <div class="col-md-6">
                                <input id="customer_email_application" name="customer_email_application" type="text" class="form-control" placeholder="Enter Email">
                            </div>
                        </div>
                        <div class="custom-control">
                            <button type="submit" class="btn btn-primary" title="btn btn-primary" data-toggle="tooltip">Send App Link</button>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    // $("#email_box").hide();
    //
    // $('input[id="send_app"]').on("click", function(e) {
    //
    //     $("#email_box").show();
    //
    // });

    $('input[id="own"]').on("click", function(e) {
        $("#email_box").hide();
        ...
        $('#new-app').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    window.location.href = 'new-application.php';
